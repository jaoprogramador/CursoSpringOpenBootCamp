...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public User findById(Long id) {
       // return userRepository.findById(id);
    	if(id == null){
    		throw new IllegalArgumentException("Valor de id de usuario incorrecto, debe introducir un numero");
    	}
    	throw new NoSuchElementException("No se encuentra el ID del usuario en BD");
    }
