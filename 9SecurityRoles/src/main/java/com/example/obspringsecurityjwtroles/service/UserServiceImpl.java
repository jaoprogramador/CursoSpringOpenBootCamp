...
import com.example.obspringsecurityjwtroles.exception.TelefonoAlreadyExistsException;
...
public class UserServiceImpl implements UserDetailsService, UserService {
    ...
    public User save(UserDto user) {
        ...
        if(userRepository.existsByPhone(nUser.getPhone())){
        	throw new TelefonoAlreadyExistsException("Telefono ocupado");
        }
